                      ...
                      <div className="flex flex-col sm:flex-row items-start justify-between gap-4 mb-3">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                          <button
                            ...
                            disabled={inToWatch}
                            className={`px-3 sm:px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 text-sm sm:text-base ${inToWatch
                          ...
                          <button
                            ...
                            disabled={inWatched}
                            className={`px-3 sm:px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 text-sm sm:text-base ${inWatched
                              ? 'bg-gray-600/50 text-gray-400 cursor-not-allowed'
